...
public class C4_3_数値微分 {
    ...
    public void C4_3_2_数値微分の例() {
        assertEquals(0.200, numerical_diff(this::function_1, 5), 5e-2);
        assertEquals(0.300, numerical_diff(this::function_1, 10), 5e-2);
        assertEquals(0.200, function_1_diff(5), 5e-2);
        assertEquals(0.300, function_1_diff(10), 5e-2);
    }
    ...
    public void C4_3_3_偏微分() {
        ...
        assertEquals(6.00, numerical_diff(function_tmp1, 3.0), 5e-2);
        DoubleUnaryOperator function_tmp2 = x1 -> 3.0 * 3.0 + x1 * x1;
        assertEquals(8.00, numerical_diff(function_tmp2, 4.0), 5e-2);
    }
